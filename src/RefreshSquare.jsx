...
var Broken = function Broken(props) {
  return React.createElement(React.Fragment, null, React.createElement("path", {"d":"M17.5 12C17.5 15.04 15.04 17.5 12 17.5C8.96 17.5 7.10999 14.44 7.10999 14.44M7.10999 14.44H9.59M7.10999 14.44V17.19M6.5 12C6.5 8.96 8.94 6.5 12 6.5C15.67 6.5 17.5 9.56 17.5 9.56M17.5 9.56V6.81M17.5 9.56H15.06","stroke":"currentColor","strokeWidth":"1.5","strokeLinecap":"round","strokeLinejoin":"round"}),React.createElement("path", {"d":"M2 14V15C2 20 4 22 9 22H15C20 22 22 20 22 15V9C22 4 20 2 15 2H9C4 2 2 4 2 9","stroke":"currentColor","strokeWidth":"1.5","strokeLinecap":"round","strokeLinejoin":"round"}),);
};

var Bulk = function Bulk(props) {
  return React.createElement(React.Fragment, null, React.createElement("path", {"fill":"currentColor","opacity":"0.4","d":"M16.19 2H7.82001C4.17001 2 2 4.17 2 7.81V16.18C2 19.82 4.17 21.99 7.81 21.99H16.18C19.82 21.99 21.99 19.82 21.99 16.18V7.81C22 4.17 19.83 2 16.19 2Z"}),React.createElement("path", {"fill":"currentColor","d":"M18 11.2695C17.58 11.2695 17.25 11.5995 17.25 12.0195C17.24 13.4195 16.7 14.7295 15.72 15.7095C14.73 16.6995 13.41 17.2495 12.01 17.2495C10.61 17.2495 9.28999 16.6995 8.29999 15.7095C8.26999 15.6795 8.25 15.6495 8.22 15.6195H9.04999C9.45999 15.6195 9.79999 15.2795 9.79999 14.8695C9.79999 14.4595 9.45999 14.1195 9.04999 14.1195H6.39999C5.98999 14.1195 5.64999 14.4595 5.64999 14.8695V17.5195C5.64999 17.9295 5.98999 18.2695 6.39999 18.2695C6.80999 18.2695 7.14999 17.9295 7.14999 17.5195V16.6695C7.17999 16.6995 7.20999 16.7395 7.23999 16.7795C8.50999 18.0495 10.21 18.7595 12.01 18.7595C13.81 18.7595 15.51 18.0595 16.78 16.7795C18.04 15.5195 18.74 13.8295 18.75 12.0295C18.75 11.6095 18.41 11.2795 18 11.2695Z"}),React.createElement("path", {"fill":"currentColor","d":"M6.00001 12.65C6.41001 12.65 6.74001 12.32 6.75001 11.91C6.77001 10.54 7.32001 9.25 8.28001 8.28C9.27001 7.29 10.59 6.74 11.99 6.74C13.39 6.74 14.71 7.29 15.7 8.28C15.73 8.31 15.75 8.34 15.78 8.37H14.95C14.54 8.37 14.2 8.71 14.2 9.12C14.2 9.53 14.54 9.87 14.95 9.87H17.6C18.01 9.87 18.35 9.53 18.35 9.12V6.48C18.35 6.07 18.01 5.73 17.6 5.73C17.19 5.73 16.85 6.07 16.85 6.48V7.34C16.82 7.31 16.79 7.27 16.76 7.23C15.49 5.96 13.79 5.25 11.99 5.25C10.19 5.25 8.49001 5.95 7.22001 7.23C5.97001 8.47 5.27001 10.13 5.25001 11.89C5.24001 12.3 5.57 12.64 5.99 12.65C6 12.65 6.00001 12.65 6.00001 12.65Z"}),);
};

var Linear = function Linear(props) {
  return React.createElement(React.Fragment, null, React.createElement("path", {"d":"M9 22H15C20 22 22 20 22 15V9C22 4 20 2 15 2H9C4 2 2 4 2 9V15C2 20 4 22 9 22Z","stroke":"currentColor","strokeWidth":"1.5","strokeLinecap":"round","strokeLinejoin":"round"}),React.createElement("path", {"d":"M17.5 12C17.5 15.04 15.04 17.5 12 17.5C8.96 17.5 7.10999 14.44 7.10999 14.44M7.10999 14.44H9.59M7.10999 14.44V17.19M6.5 12C6.5 8.96 8.94 6.5 12 6.5C15.67 6.5 17.5 9.56 17.5 9.56M17.5 9.56V6.81M17.5 9.56H15.06","stroke":"currentColor","strokeWidth":"1.5","strokeLinecap":"round","strokeLinejoin":"round"}),);
};

var Outline = function Outline(props) {
  return React.createElement(React.Fragment, null, React.createElement("path", {"d":"M15 22.75H9C3.57 22.75 1.25 20.43 1.25 15V9C1.25 3.57 3.57 1.25 9 1.25H15C20.43 1.25 22.75 3.57 22.75 9V15C22.75 20.43 20.43 22.75 15 22.75ZM9 2.75C4.39 2.75 2.75 4.39 2.75 9V15C2.75 19.61 4.39 21.25 9 21.25H15C19.61 21.25 21.25 19.61 21.25 15V9C21.25 4.39 19.61 2.75 15 2.75H9Z"}),React.createElement("path", {"d":"M17.5 12C17.5 15.04 15.04 17.5 12 17.5C8.96 17.5 7.10999 14.44 7.10999 14.44M7.10999 14.44H9.59M7.10999 14.44V17.19M6.5 12C6.5 8.96 8.94 6.5 12 6.5C15.67 6.5 17.5 9.56 17.5 9.56M17.5 9.56V6.81M17.5 9.56H15.06","stroke":"currentColor","strokeWidth":"1.5","strokeLinecap":"round","strokeLinejoin":"round"}),);
};

var TwoTone = function TwoTone(props) {
  return React.createElement(React.Fragment, null, React.createElement("path", {"d":"M9 22H15C20 22 22 20 22 15V9C22 4 20 2 15 2H9C4 2 2 4 2 9V15C2 20 4 22 9 22Z","stroke":"currentColor","strokeWidth":"1.5","strokeLinecap":"round","strokeLinejoin":"round"}),React.createElement("path", {"opacity":"0.4","d":"M17.5 12C17.5 15.04 15.04 17.5 12 17.5C8.96 17.5 7.10999 14.44 7.10999 14.44M7.10999 14.44H9.59M7.10999 14.44V17.19M6.5 12C6.5 8.96 8.94 6.5 12 6.5C15.67 6.5 17.5 9.56 17.5 9.56M17.5 9.56V6.81M17.5 9.56H15.06","stroke":"currentColor","strokeWidth":"1.5","strokeLinecap":"round","strokeLinejoin":"round"}),);
};
...
var RefreshSquare = React.forwardRef(function(props, ref) {
