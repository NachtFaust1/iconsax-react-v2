...
var Bulk = function Bulk(props) {
  return React.createElement(React.Fragment, null, React.createElement("path", {"opacity":"0.4","d":"M22 7.81V16.19C22 19.83 19.83 22 16.19 22H7.81C7.61 22 7.41 21.99 7.22 21.98C5.99 21.9 4.95 21.55 4.13 20.95C3.71 20.66 3.34 20.29 3.05 19.87C2.36 18.92 2 17.68 2 16.19V7.81C2 4.37 3.94 2.24 7.22 2.03C7.41 2.01 7.61 2 7.81 2H16.19C17.68 2 18.92 2.36 19.87 3.05C20.29 3.34 20.66 3.71 20.95 4.13C21.64 5.08 22 6.32 22 7.81Z"}),React.createElement("path", {"d":"M8.16 6.65039H15.83C16.47 6.65039 16.99 7.17039 16.99 7.81039V9.09039C16.99 9.56039 16.7 10.1404 16.41 10.4304L13.91 12.6404C13.56 12.9304 13.33 13.5104 13.33 13.9804V16.4804C13.33 16.8304 13.1 17.2904 12.81 17.4704L12 17.9804C11.24 18.4504 10.2 17.9204 10.2 16.9904V13.9104C10.2 13.5004 9.97 12.9804 9.73 12.6904L7.52 10.3604C7.23 10.0804 7 9.55039 7 9.20039V7.87039C7 7.17039 7.52 6.65039 8.16 6.65039Z"}),);
};
