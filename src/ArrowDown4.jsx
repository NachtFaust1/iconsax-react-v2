...
var Bold = function Bold(props) {
  return React.createElement(React.Fragment, null, React.createElement("path", {"fill":"currentColor","d":"M9.32993 6H14.6699C17.9899 6 19.3399 8.35 17.6899 11.22L16.9499 12.5C16.7699 12.81 16.4399 13 16.0799 13H7.91993C7.55993 13 7.22993 12.81 7.04993 12.5L6.30992 11.22C4.65992 8.35 6.00993 6 9.32993 6Z"}),React.createElement("path", {"fill":"currentColor","d":"M8.79006 14H15.2201C15.6101 14 15.8501 14.42 15.6501 14.75L15.0101 15.85C13.3601 18.72 10.6401 18.72 8.99006 15.85L8.35006 14.75C8.16006 14.42 8.40006 14 8.79006 14Z"}),);
};
...
var Bulk = function Bulk(props) {
  return React.createElement(React.Fragment, null, React.createElement("path", {"fill":"currentColor","d":"M9.33 6H14.67C17.99 6 19.34 8.35 17.69 11.22L16.95 12.5C16.77 12.81 16.44 13 16.08 13H7.92C7.56 13 7.23 12.81 7.05 12.5L6.31 11.22C4.66 8.35 6.01 6 9.33 6Z"}),React.createElement("path", {"fill":"currentColor","opacity":"0.4","d":"M8.79 14H15.22C15.61 14 15.85 14.42 15.65 14.75L15.01 15.85C13.36 18.72 10.64 18.72 8.99 15.85L8.35 14.75C8.16 14.42 8.4 14 8.79 14Z"}),);
};
